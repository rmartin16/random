...
def copy_file(src, dst, progress_bar=True):
    ...
    Note:
     src and dst must be fully qualified, absolute, and expanded filepaths.
     dst must actually be an actual file...not just a path to the destination directory

    :param src: file to be copied
    :param dst: destination for new file
    :param progress_bar: True to print a progress bar
